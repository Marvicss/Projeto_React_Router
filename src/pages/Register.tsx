          ...
          <Container maxWidth="xs" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Box component="form" noValidate autoComplete="off" sx={{ mt: 2, width: '100%' }} onSubmit={handleSubmit}>
              <Stack spacing={2}>
                ...
                <TextField required fullWidth name="password" label="Senha" type="password" id="password" autoComplete="new-password" variant="outlined" />
                <TextField required fullWidth name="confirmPassword" label="Repetir senha" type="password" id="confirmPassword" variant="outlined" />
